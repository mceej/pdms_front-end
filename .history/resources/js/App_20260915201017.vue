                    ...
                    <div class="table-header">
                        <div class="table-header-main">
                            <div class="breadcrumb-tabs" aria-label="Dashboard hierarchy">
                                <template v-if="activeLevel === 'region'">
                                    <span class="breadcrumb-current">Region XI</span>
                                </template>
                                <template v-else-if="activeLevel === 'province'">
                                    <button type="button" class="breadcrumb-tab" @click="goToLevel('region')">
                                        Region XI
                                    </button>
                                    <span class="breadcrumb-separator">›</span>
                                    <span class="breadcrumb-current">Provinces</span>
                                </template>
                                <template v-else-if="activeLevel === 'municipality'">
                                    <button type="button" class="breadcrumb-tab" @click="goToLevel('province')">
                                        Provinces
                                    </button>
                                    <span class="breadcrumb-separator">›</span>
                                    <span class="breadcrumb-current">Municipality</span>
                                </template>
                                <template v-else-if="activeLevel === 'barangay'">
                                    <button type="button" class="breadcrumb-tab" @click="goToLevel('municipality')">
                                        Municipality
                                    </button>
                                    <span class="breadcrumb-separator">›</span>
                                    <span class="breadcrumb-current">Barangay</span>
                                </template>
                                <template v-else>
                                    <button type="button" class="breadcrumb-tab" @click="goToLevel('municipality')">
                                        Municipality
                                    ...
                                    <span class="breadcrumb-separator">›</span>
                                    <span class="breadcrumb-current">{{ selectedBarangay.name }}</span>
                                </template>
                            </div>
...
const activeLevel = computed(() => {
    ...
    if (selectedRegion.value) return 'province';
    return 'region';
});
...
const currentTableRows = computed(() => {
    if (activeLevel.value === 'region') {
        return [{
            name: 'REGION XI',
            target: dashboardData[activeTab.value].target,
            paid: dashboardData[activeTab.value].paid,
            progress: dashboardData[activeTab.value].progress,
        }];
    }
...
const tableTitle = computed(() => {
    ...
    if (selectedRegion.value) return `${selectedRegion.value.name} > Provinces`;
    return 'Regions';
});
