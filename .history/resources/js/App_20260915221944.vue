...
/* Align numeric columns (Total Target, Paid) with their headers */
...
.dashboard-table :deep(.p-datatable-tbody > tr > td:nth-child(2) .paid-cell) {
...
/* Match the footer totals to the right-aligned Total Target and Paid columns */
.total-target,
.total-paid {
    text-align: right;
    padding-right: 14px;
