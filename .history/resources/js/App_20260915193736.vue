    ...
    <div class="app-shell">
        ...
        <div v-else class="dashboard-page">
            <div class="dashboard-shell">
                ...
                <section v-if="activeLevel !== 'detail'" class="table-panel">
                    <div class="table-header">
                        <div class="table-header-main">
                            <h2>{{ tableTitle }}</h2>
                            <button v-if="selectedProvince || selectedMunicipality || selectedBarangay" type="button" class="back-btn" @click="goBack">
                                Back
                            </button>
                        </div>
                    </div>

                    <div v-if="activeLevel === 'detail'" class="detail-panel">
                        ...
                        <div class="detail-grid">
                            <div class="detail-card">
                                ...
                                <strong>{{ selectedBarangay.target }}</strong>
                            </div>
                            <div class="detail-card">
                                <label>Paid</label>
                                <strong>{{ selectedBarangay.paid }}</strong>
                            </div>
                            <div class="detail-card">
                                <label>Progress</label>
                                <strong>{{ selectedBarangay.progress }}%</strong>
                            </div>
                            <div class="detail-card">
                                <label>Beneficiaries</label>
                                <strong>{{ selectedBarangay.beneficiaries }}</strong>
                            </div>
                        </div>
                    </div>
