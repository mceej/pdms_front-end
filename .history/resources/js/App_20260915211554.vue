                    ...
                    <div v-else class="chart-grid">
                        <div class="chart-card">
                            ...
                            <div class="bar-group" v-for="(row, index) in comparisonRows" :key="row.id || index">
                                <div class="bar-column">
                                    <div class="bar" :style="{ height: Math.min(row.progress * 2, 200) + 'px' }"></div>
                                </div>
                            </div>
                            <div class="x-axis">
                                <span v-for="row in comparisonRows" :key="row.id">{{ row.name }}</span>
                            </div>
                        </div>
                        <div class="chart-card">
                            <div class="chart-y-axis">
                            ...
                            <div class="bar-group" v-for="(row, index) in comparisonRows" :key="row.id || index">
                                <div class="bar-column">
                                    <div class="bar alt" :style="{ height: Math.min(row.progress * 2, 200) + 'px' }"></div>
                                </div>
                            </div>
                            <div class="x-axis">
                                <span v-for="row in comparisonRows" :key="row.id">{{ row.name }}</span>
